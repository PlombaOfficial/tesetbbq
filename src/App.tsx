...
export function App() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = clashNet.subscribeToRoom(
      ...
      (updatedRoom) => {
        ...
        // Sync View Phase with Room State
        if (updatedRoom.phase === 'ROLE_REVEAL' && currentView !== 'ROLE_REVEAL') {
          setCurrentView('ROLE_REVEAL');
        } else if (updatedRoom.phase === 'DECK_SELECT' && currentView !== 'DECK_SELECT') {
          setCurrentView('DECK_SELECT');
        } else if (updatedRoom.phase === 'MATCH' && currentView !== 'MATCH') {
  ...
  const handleRoleRevealFinished = () => {
    setCurrentView('DECK_SELECT');
  };
