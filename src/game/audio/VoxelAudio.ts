export class VoxelAudioEngine {
  ...
  // Block Break Digging Crack
  public playBlockCrack(materialType: 'stone' | 'wood' | 'dirt' | 'leaves' | 'sand') {
    this.init();
  ...
  // Ambient Chime on Daytime
  public playDaylightChime() {
    this.init();
    if (!this.ctx || !this.masterGain) return;
